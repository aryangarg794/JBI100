...
class BestPlayersPitch(html.Div):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            children=[
                ...
                make_filter_boxes(),
                dcc.Graph(figure=make_pitch_figure(
                    self.dimensions,
    ...
    def update(self, filters={"attack": "goals", "defense":"tackles", "goalkeeper":"gk_clean_sheets", "midfield":"passes"}, age_filter=["higher", 0], 
               value=["higher", 0], countries=[]):
        
        # get best players
        best_forwards, best_defenders, best_midfielders, best_keeper = self.find_best_players(filters, age_filter, value, countries)
    ...
    return html.Div(
        ...
        children=[
            ...
            dcc.Dropdown(
                ...
                value=None,
                searchable=True,
                placeholder="Select countries or leave blank to choose all"
            ),
            html.Label("Age"),
            dcc.Dropdown(
